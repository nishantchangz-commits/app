...
if page == "🏠 Home":
    ...
    # IMPORTANT: triple double quotes avoid apostrophe/quote syntax errors.
    st.markdown("""
    <div class="quote">
        "May your journey through India's sacred places bring peace, devotion and inspiration."
    </div>
    """, unsafe_allow_html=True)
    ...
    You can add your own deity photographs, temple photographs, history,
    timings, festivals, mantras, locations and official links later.
    """)
